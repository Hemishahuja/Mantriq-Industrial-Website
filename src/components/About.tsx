      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-slide-in-left">
            ...
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-primary-foreground hover-lift hover-glow transition-all duration-300 animate-scale-in stagger-4"
            >
              Learn More About Us
            </Button>
          </div>
              ...
              {pillars.map((pillar, index) => (
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 hover-scale transition-all duration-300 animate-pulse-glow">
