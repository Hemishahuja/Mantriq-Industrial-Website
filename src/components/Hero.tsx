    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-4xl">
          <div className="bg-primary text-primary-foreground inline-block px-6 py-3 rounded-lg mb-6 animate-slide-in-left hover-glow">
          ...
          <div className="text-white">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight animate-fade-in stagger-2">
              Precision CNC Machining for Canada's Industries
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl animate-slide-up stagger-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in stagger-4">
              <Button 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-lg hover-lift hover-glow transition-all duration-300"
              >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce-subtle">
        <div className="w-1 h-8 bg-primary rounded-full animate-pulse-glow"></div>
      </div>
    </section>
  );
};
