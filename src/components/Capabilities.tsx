    ...
    <section id="capabilities" className="py-20 bg-secondary">
      <div className="container mx-auto px-4">
            ...
            <CardContent className="p-8">
              ...
              <ul className="space-y-4">
                {turningCapabilities.map((capability, index) => (
                  ...
                  >
                    <ArrowRight className="w-5 h-5 text-primary mr-3 mt-0.5 flex-shrink-0 hover-scale" />
        ...
        <div className="text-center mt-12 animate-fade-in stagger-6">
          <Button 
            size="lg" 
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 hover-lift hover-glow transition-all duration-300"
          >
